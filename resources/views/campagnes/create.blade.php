...
<head>
    ...
    <title>Nouvelle Campagne - DonaLink</title>
...
<div class="main-content">
    ...
    <div class="page-header">
        <div>
            ...
            <small>Créer une nouvelle campagne de dons</small>
        </div>
    ...
    <div class="form-card">
        <form action="/campagnes" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="titre"
                        ...
                        value="{{ old('titre') }}"
                        placeholder="Ex: Aide aux enfants de Dakar">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="Décrivez l'objectif de cette campagne...">{{ old('description') }}</textarea>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <select name="type" id="type"
                        ...
                        <option value="financiere" {{ old('type') == 'financiere' ? 'selected' : '' }}>Financière</option>
                        <option value="materielle" {{ old('type') == 'materielle' ? 'selected' : '' }}>Matérielle</option>
                    </select>
                    @error('type') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4" id="champ_objectif"></div>
                <div class="col-md-4">
                    <label class="form-label">Image de la campagne</label>
