...
<head>
    ...
    <title>Nouveau Bénéficiaire - DonaLink</title>
...
<div class="main-content">
    ...
    <div class="page-header">
        <div>
            ...
            <small>Ajouter une personne dans le besoin</small>
        </div>
    ...
    <div class="form-card">
        <form action="/beneficiaires" method="POST">
            @csrf
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="prenom"
                        ...
                        value="{{ old('prenom') }}" placeholder="Ex: Moussa">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="telephone"
                        ...
                        value="{{ old('telephone') }}" placeholder="Ex: 77 123 45 67">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="adresse"
                        ...
                        value="{{ old('adresse') }}" placeholder="Ex: Dakar, Médina">
            ...
            <div class="mb-3">
                ...
                <textarea name="besoins" rows="4"
                    class="form-control @error('besoins') is-invalid @enderror"
                    placeholder="Décrivez les besoins de cette personne...">{{ old('besoins') }}</textarea>
